...
const ITEMS = {
  ...
  "Sample Experience": { startingBid: 50, quantity: 1 },
  "Sample Food & Drink Basket": { startingBid: 25, quantity: 1 },
  "Sample Handmade Item": { startingBid: 20, quantity: 1 },
  "Sample Jewelry Piece": { startingBid: 15, quantity: 1 },
  "Sample Holiday Item": { startingBid: 10, quantity: 1 },
  "Sample Multi-Winner Item": { startingBid: 10, quantity: 4 },
};
// ITEMS:END
